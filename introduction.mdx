...
native protocol, with **OpenAI Chat Completions** and **OpenAI Responses**
shimmed transparently. Behind one key you get text, image, video, embedding,
and rerank endpoints — billed in transparent credits, not per-vendor SKUs.
...
- **Multimodal under one key** — image, video, text, embedding, rerank — no per-vendor billing surface to assemble.
